...
function rgb(color: string) { return isGold(color) ? "240,180,41" : "29,223,184"; }
  ...
  return (
    <div style={{ padding: "100px clamp(1.5rem,5vw,3.5rem) 96px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 12 }}>
                      ...
                      {selectedMentor === m.id && (
                        <div style={{ width: 22, height: 22, borderRadius: "50%", background: m.color, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#062A35" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                        </div>
                      )}
                    </div>
        ...
        {/* ── BOTTOM CTA ── */}
        <FadeIn delay={0.2}>
          <div className="glass" style={{ borderRadius: 22, padding: "36px 40px", marginTop: 64, display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 24, borderColor: "rgba(29,223,184,0.15)" }}>
            <div>
