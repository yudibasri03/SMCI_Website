        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(220px, 100%), 1fr))", gap: 40, alignItems: "start" }}>
          ...
          <FadeIn direction="left">
            <div style={{ position: "sticky", top: 100 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                {categories.map(cat => (
                  <button
                    ...
                    style={{
                      background: activeCategory === cat ? "rgba(0,201,177,0.1)" : "transparent",
                      border: "none",
                      borderRadius: 10,
                      padding: "10px 14px",
                      textAlign: "left",
              ...
              {/* Quick contact */}
              <div className="glass" style={{ borderRadius: 16, padding: "24px", marginTop: 32, borderColor: "rgba(0,201,177,0.1)" }}>
                  ...
                  {currentFaqs.map((item, i) => {
                    ...
                    return (
                      <div
                        key={id}
                        className="glass"
                        style={{ borderRadius: 16, overflow: "hidden", borderColor: isOpen ? "rgba(0,201,177,0.2)" : "var(--border-subtle)", transition: "border-color 0.3s" }}
                      >
                        <button
                        ...
                        >
                          ...
                          <div style={{ width: 28, height: 28, borderRadius: "50%", border: `1px solid ${isOpen ? "var(--cyan)" : "var(--border-subtle)"}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, transition: "all 0.3s", background: isOpen ? "rgba(0,201,177,0.1)" : "transparent" }}>
