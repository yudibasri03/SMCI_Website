                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16, minWidth: 120 }}>
                  <div style={{ position: "relative" }}>
                    <div style={{
                      ...
                      background: `linear-gradient(135deg, rgba(${mentor.color === "var(--cyan)" ? "0,201,177" : "240,180,41"},0.2), rgba(${mentor.color === "var(--cyan)" ? "0,201,177" : "240,180,41"},0.05))`,
                      border: `2px solid rgba(${mentor.color === "var(--cyan)" ? "0,201,177" : "240,180,41"},0.4)`,
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 40, color: mentor.color,
                      boxShadow: `0 0 40px rgba(${mentor.color === "var(--cyan)" ? "0,201,177" : "240,180,41"},0.15)`,
                    }}>
                      {mentor.initial}
                    </div>
                  ...
                  <span style={{
                    ...
                    color: mentor.color,
                    border: `1px solid rgba(${mentor.color === "var(--cyan)" ? "0,201,177" : "240,180,41"},0.3)`,
                    background: `rgba(${mentor.color === "var(--cyan)" ? "0,201,177" : "240,180,41"},0.08)`,
                    textAlign: "center",
                  }}>
                    {mentor.specialty}
                  </span>
        ...
        <FadeIn delay={0.2}>
          <div style={{ marginTop: 72, textAlign: "center" }}>
            <div style={{ position: "relative", display: "inline-block", padding: "56px 48px" }}>
              <div style={{ position: "absolute", inset: 0, borderRadius: 24, border: "1px solid rgba(0,201,177,0.12)", background: "rgba(0,201,177,0.03)" }} />
