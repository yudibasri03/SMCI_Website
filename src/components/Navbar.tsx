    ...
    <>
      <header
        style={{
          ...
          background: scrolled ? "rgba(10,22,48,0.92)" : "transparent",
      ...
      >
        ...
        <button onClick={() => handleNav("/")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "12px" }}>
          <div style={{
            ...
            background: "linear-gradient(135deg, rgba(0,201,177,0.2) 0%, rgba(0,201,177,0.05) 100%)",
            border: "1px solid rgba(0,201,177,0.3)",
            display: "flex", alignItems: "center", justifyContent: "center",
          }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#00C9B1" strokeWidth="2">
        ...
        <button
          ...
          style={{
            background: menuOpen ? "rgba(0,201,177,0.12)" : "rgba(255,255,255,0.05)",
            border: `1px solid ${menuOpen ? "rgba(0,201,177,0.3)" : "rgba(255,255,255,0.08)"}`,
            ...
            <nav style={{ flex: 1, padding: "24px 24px 0", display: "flex", flexDirection: "column", gap: 4 }}>
              {navLinks.map(({ href, label }, i) => (
                <motion.button
                  ...
                  onClick={() => handleNav(href)}
                  style={{
                    background: location === href ? "rgba(0,201,177,0.08)" : "transparent",
                    border: "none",
                    borderRadius: "14px",
                    padding: "18px 20px",
