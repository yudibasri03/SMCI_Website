...
export default function Footer() {
  ...
  return (
    <footer style={{ position: "relative", zIndex: 1, borderTop: "1px solid rgba(255,255,255,0.07)", background: "rgba(4,28,35,0.85)", padding: "64px clamp(1.5rem,5vw,3.5rem) 32px" }}>
